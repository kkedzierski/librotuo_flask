...
from librotuo import db, bcrypt
from librotuo.users.forms import (RegistrationForm, LoginForm,
                                  UpdateAccountForm, RequestResetForm,
                                  ResetPasswordForm)
from librotuo.models import User, Book
from flask_login import login_user, current_user, logout_user, login_required
from librotuo.users.utils import save_picture, send_reset_email
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with instruction '
              'to reset to your password', 'info')
        return redirect(url_for('users.login'))
    return render_template('reset_request.html',
                           title='Reset Passoword', form=form)
